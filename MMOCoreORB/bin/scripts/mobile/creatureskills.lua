...
forcepowermaster = { {"forcelightningsingle2",""},{"forcelightningcone2",""},{"mindblast2",""},{"forceknockdown2",""},{"forceweaken2",""},{"forcethrow2",""} }

-- npc force wielders use standard profession mastery with the addition of this command
forcewielder ={ {"forcelightningsingle1",""},{"mindblast1",""},{"forceweaken1",""},{"forceknockdown1",""},{"forcelightningcone1",""} }
