...
function RoriImperialEncampmentScreenPlay:spawnImperials()
	...
	spawnMobile("rori", "storm_commando", 300, -5623.5, 75.9, -5665.5, -90, 0)
	spawnMobile("rori", "storm_commando", 300, -5623.5, 75.9, -5658.7, -90, 0)
	spawnMobile("rori", "storm_commando", 300, -5627.5, 75.9, -5661.6, -90, 0)

	spawnMobile("rori", "storm_commando", 300, -5599.3, 75.9, -5633.7, 180, 0)
	spawnMobile("rori", "storm_commando", 300, -5595.8, 75.9, -5633.7, 180, 0)
	...
	spawnMobile("rori", "storm_commando", 300, -5532.3, 75.9, -5690.0, 0, 0)
	spawnMobile("rori", "storm_commando", 300, -5527.8, 75.9, -5690.0, 0, 0)

	spawnMobile("rori", "imperial_general", 300, -5569.1, 75.9, -5630.4, 0, 0)
	spawnMobile("rori", "imperial_general", 300, -5562.1, 75.9, -5630.4, 0, 0)
	...
	spawnMobile("rori", "imperial_general", 300, -5514.7, 82.9, -5622.7, 0, 0)
	...
	spawnMobile("rori", "imperial_general", 300, -5618.5, 82.6, -5702.6, -135, 0)
	spawnMobile("rori", "stormtrooper_squad_leader", 300, -5613.1, 82.6, -5703.4, 180, 0)

	--buildings

	spawnMobile("rori", "imperial_high_general", 300, 4.9, 0.0, -2.0, -135, 3475375)
	...
	spawnMobile("rori", "imperial_high_general", 300, 0.0, 0.0, -5.3, 0, 3475366)
	...
	spawnMobile("rori", "imperial_high_general", 300, -17.7, 1.0, 16.5, 180, 2935408)
	spawnMobile("rori", "imperial_general", 300, 18.3, 1.0, -19.7, -45, 2935410)
	...
	spawnMobile("rori", "elite_novatrooper_commander", 300, -9.2, 7.0, -13.5, 0, 2935414)
	spawnMobile("rori", "elite_novatrooper_commander", 300, -11.7, 7.0, -13.5, 0, 2935414)

	spawnMobile("rori", "imperial_major", 300, -11.5, 7.0, 9.3, 90, 2935415)
	spawnMobile("rori", "imperial_general", 300, -9.1, 7.0, 12.5, 0, 2935415)
	spawnMobile("rori", "imperial_high_general", 300, 0.0, 7.0, 12.6, 0, 2935415)
