...
object_draft_schematic_weapon_lightsaber_old_republic = object_draft_schematic_weapon_lightsaber_shared_old_republic:new {

templateType = DRAFTSCHEMATIC,

   customObjectName = "An Ancient one-handed Old Republic Lightsaber",
   ...
   targetTemplate = "object/weapon/melee/sword/crafted_saber/sword_lightsaber_one_handed_s12.iff",

   additionalTemplates = {}
}

ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_old_republic, "object/draft_schematic/weapon/lightsaber/old_republic.iff")
