...
object_draft_schematic_clothing_clothing_armor_infiltrator_s01_belt = object_draft_schematic_clothing_shared_clothing_armor_infiltrator_s01_belt:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Infiltrator Armor Belt",
   ...
   targetTemplate = "object/tangible/wearables/armor/infiltrator/armor_infiltrator_s01_belt.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_infiltrator_s01_belt, "object/draft_schematic/clothing/clothing_armor_infiltrator_s01_belt.iff")
