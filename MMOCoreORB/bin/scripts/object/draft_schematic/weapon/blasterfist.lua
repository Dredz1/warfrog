...
object_draft_schematic_weapon_blasterfist = object_draft_schematic_weapon_shared_razor_knuckler:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Blasterfist Schematic",
   factoryCrateSize = 0,
   ...
   targetTemplate = "object/weapon/melee/special/blaster_fist.iff",
