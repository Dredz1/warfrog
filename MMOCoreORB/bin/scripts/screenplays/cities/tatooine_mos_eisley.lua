...
function TatooineMosEisleyScreenPlay:spawnMobiles()
	...
	spawnMobile(self.planet, "old_man_start",300,3478,5,-4918,-10,0)

	--GCW TRAINER
	spawnMobile(self.planet, "trainer_gcwbh",300,3464,5,-4918,5,0)
	spawnMobile(self.planet, "trainer_gcwcommando",300,3462,5,-4918,5,0)
	spawnMobile(self.planet, "trainer_gcwbrawler",300,3460,5,-4918,5,0)
	spawnMobile(self.planet, "trainer_gcwmedic",300,3458,5,-4918,5,0)
	spawnMobile(self.planet, "trainer_gcwsmuggler",300,3456,5,-4918,5,0)
	spawnMobile(self.planet, "trainer_gcwsl",300,3454,5,-4918,5,0)
	spawnMobile(self.planet, "trainer_gcwranger",300,3452,5,-4918,5,0)
