...
object_draft_schematic_clothing_clothing_armor_rebel_spec_force_chest_plate = object_draft_schematic_clothing_shared_clothing_armor_rebel_spec_force_chest_plate:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Spec Force Armor Chest",
   ...
   targetTemplate = "object/tangible/wearables/armor/rebel_spec_force/armor_rebel_spec_force_chest_plate.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_rebel_spec_force_chest_plate, "object/draft_schematic/clothing/clothing_armor_rebel_spec_force_chest_plate.iff")
