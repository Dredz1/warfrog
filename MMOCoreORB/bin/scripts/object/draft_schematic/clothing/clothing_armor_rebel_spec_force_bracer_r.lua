...
object_draft_schematic_clothing_clothing_armor_rebel_spec_force_bracer_r = object_draft_schematic_clothing_shared_clothing_armor_rebel_spec_force_bracer_r:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Spec Force Armor Bracer r",
   ...
   targetTemplate = "object/tangible/wearables/armor/rebel_spec_force/armor_rebel_spec_force_bracer_r.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_rebel_spec_force_bracer_r, "object/draft_schematic/clothing/clothing_armor_rebel_spec_force_bracer_r.iff")
