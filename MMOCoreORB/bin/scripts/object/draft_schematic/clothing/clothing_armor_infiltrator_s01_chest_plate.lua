...
object_draft_schematic_clothing_clothing_armor_infiltrator_s01_chest_plate = object_draft_schematic_clothing_shared_clothing_armor_infiltrator_s01_chest_plate:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Infiltrator Armor Chest",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_infiltrator_s01_chest_plate, "object/draft_schematic/clothing/clothing_armor_infiltrator_s01_chest_plate.iff")
