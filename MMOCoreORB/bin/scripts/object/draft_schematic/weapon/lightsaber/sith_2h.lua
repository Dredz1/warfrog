...
object_draft_schematic_weapon_lightsaber_sith_2h = object_draft_schematic_weapon_lightsaber_shared_sith_2h:new {
...
templateType = DRAFTSCHEMATIC,
   ...
   targetTemplate = "object/weapon/melee/2h_sword/crafted_saber/sword_lightsaber_two_handed_s7.iff",

   additionalTemplates = {}
}

ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_sith_2h, "object/draft_schematic/weapon/lightsaber/sith_2h.iff")
