...
object_draft_schematic_clothing_clothing_armor_infiltrator_s01_bicep_r = object_draft_schematic_clothing_shared_clothing_armor_infiltrator_s01_bicep_r:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Infiltrator Armor Bicep r",
   ...
   targetTemplate = "object/tangible/wearables/armor/infiltrator/armor_infiltrator_s01_bicep_r.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_infiltrator_s01_bicep_r, "object/draft_schematic/clothing/clothing_armor_infiltrator_s01_bicep_r.iff")
