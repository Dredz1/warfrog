...
object_draft_schematic_clothing_clothing_armor_rebel_spec_force_boots = object_draft_schematic_clothing_shared_clothing_armor_rebel_spec_force_boots:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Spec Force Armor Boots",
   ...
   targetTemplate = "object/tangible/wearables/armor/rebel_spec_force/armor_rebel_spec_force_boots.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_rebel_spec_force_boots, "object/draft_schematic/clothing/clothing_armor_rebel_spec_force_boots.iff")
