...
object_draft_schematic_structure_diner_schem = object_draft_schematic_structure_shared_diner_schem:new {
   ...
   targetTemplate = "object/tangible/deed/player_house_deed/diner.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_structure_diner_schem, "object/draft_schematic/structure/diner_schem.iff")
