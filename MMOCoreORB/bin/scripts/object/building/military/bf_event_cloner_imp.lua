...
bf_event_cloner_imp = object_building_military_shared_small_imperial_cloning_facility:new {
...
ObjectTemplates:addTemplate(bf_event_cloner_imp, "bf_event_cloner_imp.iff")
