...
object_draft_schematic_clothing_clothing_armor_rebel_spec_force_belt = object_draft_schematic_clothing_shared_clothing_armor_rebel_spec_force_belt:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Spec Force Armor Belt",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_rebel_spec_force_belt, "object/draft_schematic/clothing/clothing_armor_rebel_spec_force_belt.iff")
