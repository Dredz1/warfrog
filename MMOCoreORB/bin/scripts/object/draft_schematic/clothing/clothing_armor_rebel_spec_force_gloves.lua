...
object_draft_schematic_clothing_clothing_armor_rebel_spec_force_gloves = object_draft_schematic_clothing_shared_clothing_armor_rebel_spec_force_gloves:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Spec Force Armor Gloves",
   ...
   targetTemplate = "object/tangible/wearables/armor/rebel_spec_force/armor_rebel_spec_force_gloves.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_rebel_spec_force_gloves, "object/draft_schematic/clothing/clothing_armor_rebel_spec_force_gloves.iff")
