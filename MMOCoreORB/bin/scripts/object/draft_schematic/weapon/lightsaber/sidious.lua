...
object_draft_schematic_weapon_lightsaber_sidious = object_draft_schematic_weapon_lightsaber_shared_sidious:new {
...
templateType = DRAFTSCHEMATIC,
   ...
   targetTemplate = "object/weapon/melee/sword/crafted_saber/sword_lightsaber_one_handed_s5.iff",

   additionalTemplates = {}
}

ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_sidious, "object/draft_schematic/weapon/lightsaber/sidious.iff")
