...
--Re add insta respawn-nexxus
	...
	-->>Super Enhanced Kwi?<<<
	spawnMobile("yavin4", "crazed_geonosian_boss",900, -134.117, -34, -182.739, -179, 1627815)
	-->>Super Enhanced Kwi?<<<
	...
	-->>Enhanced Rancor??
	spawnMobile("yavin4", "geo_kkorrwrot",900, -145.7, -34.0, -369.8, 52, 1627818)
	-->>Enhanced Rancor??

	-->>Dark Jedi Jawa<<--
	spawnMobile("yavin4", "geo_jedi",1600, 4.0, -34, -347.3, -91, 1627822)
	-->>Dark Jedi Jawa<<--
end
