...
object_draft_schematic_clothing_clothing_armor_infiltrator_s01_boots = object_draft_schematic_clothing_shared_clothing_armor_infiltrator_s01_boots:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Infiltrator Armor Boots",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_infiltrator_s01_boots, "object/draft_schematic/clothing/clothing_armor_infiltrator_s01_boots.iff")
