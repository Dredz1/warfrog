...
object_draft_schematic_clothing_clothing_armor_rebel_spec_force_helmet = object_draft_schematic_clothing_shared_clothing_armor_rebel_spec_force_helmet:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Spec Force Armor Helmet",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_rebel_spec_force_helmet, "object/draft_schematic/clothing/clothing_armor_rebel_spec_force_helmet.iff")
