...
object_draft_schematic_weapon_ep3_loot_firestar = object_draft_schematic_weapon_shared_ep3_loot_firestar:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Firestar Carbine Schematic",
	...
	weaponDots = {
		{
			...
			{"attribute", 3}, -- See CreatureAttributes.h in src for numbers.
			{"strength", 200},
			{"duration", 60},
			{"potency", 70},
			{"uses", 1000}
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_ep3_loot_firestar, "object/draft_schematic/weapon/ep3_loot_firestar.iff")
