...
confirm_bribe = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"How about a 40000 credit gift of friendship?", "accepted_bribe_40k"} -- How about a 40000 credit gift of friendship?
	}
}
...
imperialRecruiterConvoTemplate:addScreen(accepted_bribe_40k);
...
imperialRecruiterConvoTemplate:addScreen(accepted_bribe_200k);
