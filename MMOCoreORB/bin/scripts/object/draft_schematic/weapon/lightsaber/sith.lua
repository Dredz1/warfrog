...
object_draft_schematic_weapon_lightsaber_sith = object_draft_schematic_weapon_lightsaber_shared_sith:new {
...
templateType = DRAFTSCHEMATIC,
   ...
   targetTemplate = "object/weapon/melee/sword/crafted_saber/sword_lightsaber_one_handed_s7.iff",

   additionalTemplates = {}
}

ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_sith, "object/draft_schematic/weapon/lightsaber/sith.iff")
