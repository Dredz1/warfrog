...
object_draft_schematic_clothing_clothing_armor_infiltrator_s01_bracer_r = object_draft_schematic_clothing_shared_clothing_armor_infiltrator_s01_bracer_r:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Infiltrator Armor Bracer r",
   ...
   targetTemplate = "object/tangible/wearables/armor/infiltrator/armor_infiltrator_s01_bracer_r.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_infiltrator_s01_bracer_r, "object/draft_schematic/clothing/clothing_armor_infiltrator_s01_bracer_r.iff")
