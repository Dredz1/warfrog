...
object_draft_schematic_weapon_lightsaber_lightsaber_juyo = object_draft_schematic_weapon_lightsaber_shared_lightsaber_juyo:new {

templateType = DRAFTSCHEMATIC,

   customObjectName = "Juyo Saberstaff",
   ...
   targetTemplate = "object/weapon/melee/polearm/crafted_saber/sword_lightsaber_polearm_s2.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_lightsaber_juyo, "object/draft_schematic/weapon/lightsaber/lightsaber_juyo.iff")
