...
object_draft_schematic_clothing_clothing_armor_mandalorian_helmet_invis = object_draft_schematic_clothing_shared_clothing_armor_mandalorian_helmet_invis:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Mandalorian Armor Helmet INVISIBLE",
   ...
   targetTemplate = "object/tangible/wearables/armor/mandalorian/armor_mandalorian_helmet_invis.iff",

   additionalTemplates = {}

}

ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_mandalorian_helmet_invis, "object/draft_schematic/clothing/clothing_armor_mandalorian_helmet_invis.iff")
