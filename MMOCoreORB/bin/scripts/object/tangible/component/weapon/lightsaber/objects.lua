...
-- Diatium Powercell
object_tangible_component_weapon_lightsaber_shared_lightsaber_diatium_powercell = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/component/weapon/lightsaber/shared_lightsaber_diatium_powercell.iff"

}
ObjectTemplates:addClientTemplate(object_tangible_component_weapon_lightsaber_shared_lightsaber_diatium_powercell, "object/tangible/component/weapon/lightsaber/shared_lightsaber_diatium_powercell.iff")
