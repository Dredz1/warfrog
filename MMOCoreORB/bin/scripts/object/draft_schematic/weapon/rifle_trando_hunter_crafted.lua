...
object_draft_schematic_weapon_rifle_trando_hunter_crafted = object_draft_schematic_weapon_shared_rifle_trando_hunter_crafted:new {
   ...
   customObjectName = "Trandoshan Hunters Rifle",
   ...
   ingredientTitleNames = {"frame_assembly", "receiver_assembly", "grip_assembly", "enhanced_cooling_mechanism", "powerhandler", "de10_barrel", "barrel", "stock"},
   ingredientSlotType = {0, 0, 0, 0, 1, 1, 1, 3},
   resourceTypes = {"steel_ditanium", "iron_polonium", "metal", "crystalline_gallinorian", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/loot/dungeon/death_watch_bunker/shared_pistol_de10_barrel.iff", "object/tangible/component/weapon/shared_blaster_rifle_barrel.iff", "object/tangible/component/weapon/shared_stock.iff"},
   resourceQuantities = {150, 85, 20, 15, 10, 1, 1, 1},
   contribution = {100, 100, 100, 100, 100, 100, 100, 100},


   targetTemplate = "object/weapon/ranged/rifle/ep3/rifle_trando_hunter_crafted.iff",
