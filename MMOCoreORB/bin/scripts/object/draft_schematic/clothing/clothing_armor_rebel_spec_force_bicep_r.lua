...
object_draft_schematic_clothing_clothing_armor_rebel_spec_force_bicep_r = object_draft_schematic_clothing_shared_clothing_armor_rebel_spec_force_bicep_r:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Spec Force Armor Bicep r",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_rebel_spec_force_bicep_r, "object/draft_schematic/clothing/clothing_armor_rebel_spec_force_bicep_r.iff")
