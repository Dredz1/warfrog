...
function DeathWatchBunkerScreenPlay:checkDoor(pSceneObject, pCreature)
	...
	elseif doorType == 3 then
		...
		createEvent(1000 * 60 * 10, "DeathWatchBunkerScreenPlay", "removeFromBunker", pCreature, "")
		createEvent(1000 * 60 * 9.5, "DeathWatchBunkerScreenPlay", "timeWarning", pCreature, "")
		createEvent(1000 * 60 * 10.5, "DeathWatchBunkerScreenPlay", "despawnCell", pCell, "")
	end
