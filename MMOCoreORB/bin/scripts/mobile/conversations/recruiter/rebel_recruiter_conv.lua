...
confirm_bribe = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"I just happen to have a spare 40000 credits for you.", "accepted_bribe_40k"} -- I just happen to have a spare 40000 credits for you.
	}
}

rebelRecruiterConvoTemplate:addScreen(confirm_bribe);

accepted_bribe_40k = ConvoScreen:new {
	id = "accepted_bribe_40k",
...
rebelRecruiterConvoTemplate:addScreen(accepted_bribe_40k);

accepted_bribe_200k = ConvoScreen:new {
	id = "accepted_bribe_200k",
...
rebelRecruiterConvoTemplate:addScreen(accepted_bribe_200k);
