...
--Diner deed
object_tangible_deed_player_house_deed_shared_diner = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/deed/player_house_deed/shared_diner.iff"
}
ObjectTemplates:addClientTemplate(object_tangible_deed_player_house_deed_shared_diner, "object/tangible/deed/player_house_deed/shared_diner.iff")
