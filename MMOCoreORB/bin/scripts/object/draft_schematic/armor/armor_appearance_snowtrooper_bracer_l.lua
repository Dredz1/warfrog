...
object_draft_schematic_armor_armor_appearance_snowtrooper_bracer_l = object_draft_schematic_armor_shared_armor_appearance_snowtrooper_bracer_l:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Snow Trooper Left Bracer",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_appearance_snowtrooper_bracer_l, "object/draft_schematic/armor/armor_appearance_snowtrooper_bracer_l.iff")
