...
object_draft_schematic_clothing_clothing_armor_infiltrator_s01_bracer_l = object_draft_schematic_clothing_shared_clothing_armor_infiltrator_s01_bracer_l:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Infiltrator Armor Bracer l",
   ...
   targetTemplate = "object/tangible/wearables/armor/infiltrator/armor_infiltrator_s01_bracer_l.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_infiltrator_s01_bracer_l, "object/draft_schematic/clothing/clothing_armor_infiltrator_s01_bracer_l.iff")
