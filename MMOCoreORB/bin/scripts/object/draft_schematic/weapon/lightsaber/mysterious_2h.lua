...
object_draft_schematic_weapon_lightsaber_mysterious_2h = object_draft_schematic_weapon_lightsaber_shared_mysterious_2h:new {
...
templateType = DRAFTSCHEMATIC,
   ...
   targetTemplate = "object/weapon/melee/2h_sword/crafted_saber/sword_lightsaber_two_handed_s2.iff",

   additionalTemplates = {}
}

ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_mysterious_2h, "object/draft_schematic/weapon/lightsaber/mysterious_2h.iff")
