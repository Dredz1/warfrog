...
object_draft_schematic_clothing_clothing_armor_infiltrator_s01_bicep_l = object_draft_schematic_clothing_shared_clothing_armor_infiltrator_s01_bicep_l:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Infiltrator Armor Bicep l",
   ...
   targetTemplate = "object/tangible/wearables/armor/infiltrator/armor_infiltrator_s01_bicep_l.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_infiltrator_s01_bicep_l, "object/draft_schematic/clothing/clothing_armor_infiltrator_s01_bicep_l.iff")
