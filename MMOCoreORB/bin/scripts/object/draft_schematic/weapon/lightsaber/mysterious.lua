...
object_draft_schematic_weapon_lightsaber_mysterious = object_draft_schematic_weapon_lightsaber_shared_mysterious:new {
...
templateType = DRAFTSCHEMATIC,
   ...
   targetTemplate = "object/weapon/melee/sword/crafted_saber/sword_lightsaber_one_handed_s2.iff",

   additionalTemplates = {}
}

ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_mysterious, "object/draft_schematic/weapon/lightsaber/mysterious.iff")
